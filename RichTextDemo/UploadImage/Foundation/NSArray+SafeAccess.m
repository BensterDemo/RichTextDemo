...
+ (NSArray *)arrayWithArr:(NSArray *)aArr
{
    if (!aArr || !([aArr isKindOfClass:[NSMutableArray class]] || [aArr isKindOfClass:[NSArray class]])) {
...
+ (NSMutableArray *)arrayWithArr:(NSArray *)aArr
{
    if (!aArr || !([aArr isKindOfClass:[NSMutableArray class]] || [aArr isKindOfClass:[NSArray class]])) {
        return [[NSMutableArray alloc] init];
    }
    
    return [self arrayWithArray:aArr];
}
